...
/*
    ...
    - % : 나머지
*/
console.log(10 / 3); // 결과값 : 3.3333333....
console.log("십" / 3); // 결과값 : NaN
...
*/
console.log(typeof +10); // 결과값 : number
console.log(typeof +"10"); // 결과값 : number
console.log(+true); // 결과값 : 1

/*
    - - 단항 연산자는 피연산자의 부호를 반전한 값을 반환
    - 숫자 타입이 아닌 피연산자에 사용하면 부호가 반전된 숫자 타입으로 변환함
*/
console.log(-10); // 결과값 : -10
console.log(-"10"); // 결과값 : -10
console.log(-true); // 결과값 : -1
...
*/
console.log(1 + "1"); // 결과값 : 11
console.log("A method Start : " + 10 + " sec"); // 결과값 : A method Start : 10 sec
console.log("A method End : " + 20 + " sec"); // 결과값 : A method End : 20 sec
console.log("A method : " + 20 + 10 + " sec"); // 결과값 : A method : 2010 sec
...
/*
    ...
    - !== 불일치 비교
*/
console.log(10 == "10"); // 결과값 : true
console.log(10 === "10"); // 결과값 : false
...
let result2 = number % 2 ? "홀수" : "짝수";
console.log(result2); // 결과값 : 홀수
...
*/
console.log(true || "홍길동"); // 결과값 : true
console.log(false || "홍길동"); // 결과값 : 홍길동
console.log(true && "홍길동"); // 결과값 : 홍길동
console.log(false && "홍길동"); // 결과값 : false
console.log("홍길동" && true); // 결과값 : true
...
*/
let type = typeof x;
console.log(type); // 결과값 : number
console.log(typeof type); // 결과값 : string
