...
console.log(func1(1,2)); // 결과값 : 3
console.log(func2(1,2)); // 결과값 : 2
// console.log(add2(1,2)); // 기명 함수 형태로 작성한 함수 표현식은 해당 함수명으로 호출 불가능
